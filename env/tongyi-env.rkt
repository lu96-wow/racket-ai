...
;; ============================================================
;; env/tongyi-env.rkt -- Tongyi/Qwen AI Dui Hua Huan Jing
;;
;; Jiang model, mo ren can shu, gong ju he liu shi hui tiao
;; da bao wei "huan jing", jian shao Tongyi API diao yong
;; de yang ban dai ma.
;;
;; Zhu: Tongyi bu zhi chi thinking / reasoning-gong neng.
;;
;; Yong Fa:
;;   (define my-env
;;     (make-env #:model qwen-max
;;               #:max_tokens 4096
;;               #:tools default-tools
...
;; ============================================================
;; make-env : Chuang Jian Tongyi Huan Jing
;;
;; Suo you #: can shu jun wei ke xuan.
;; Zhu: Tongyi bu zhi chi thinking / reasoning-effort.
;; ============================================================
